# 1- write a program that takes 2 inputs from the user: weight(kg) and height(meter) and prints the BMI in the output.
...
# 2- write a program that takes the name of the user as input and
# replace all the occurrences of character 'a' in the name to 'b' and print it.
name=str(input("Please Enter your name: "))
name = name.lower().replace('a','b')
print("Replaced Name: ",name)

# 3- write a program that takes 2 inputs from the user as the principal amount (int) and rate of annual interest (float) and
...
# 5- write a program that takes the name of the user as input and
...
# Note that the first letter of the first name and last name both should be in capital letters and the rest in small.
...
# 8-take 3 inputs from the user: first name, last name, and company name.
